...
class UsersController:
    ...
    def login_user(cls) -> Response | Tuple[Dict[str, Any], int]:
        ...
        response.set_cookie('access_token', access_token, secure=True, samesite="None", domain="127.0.0.1")
        response.set_cookie('refresh_token', refresh_token, httponly=True, secure=True, samesite="None",domain="127.0.0.1")
        return response
