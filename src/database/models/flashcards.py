...
class Flashcards(db.Model):
    ...
    term: Mapped[str] = mapped_column(String(16384), nullable=False)
    definition: Mapped[str] = mapped_column(String(16384), nullable=False)
    notes: Mapped[str] = mapped_column(String(16384), nullable=True)
